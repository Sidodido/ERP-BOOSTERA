...
export async function sendEmail({ to, subject, html, text }: SendEmailParams): Promise<{ success: boolean; simulated?: boolean }> {
  const from = process.env.SMTP_FROM || '"BOOSTERA ERP" <devnovainfo@gmail.com>';
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    ...
                    <div style="font-size: 11px; color: #64748b; margin-top: 1px;">Plateforme SaaS Agence Digitale & ERP</div>
                  </td>
                </tr>
              </table>
            </td>
